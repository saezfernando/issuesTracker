            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        <div class="panel-heading">{{ trans('ui.comi.new_comi') }}</div>
                        <div class="panel-body">
                            @include('errors.form_error')
                            <!--enctype="multipart/form-data"-->
                            {!! Form::open(array('url' => 'comunicacion-interna','files' => true, 'class' => 'cmxform form-horizontal', 'id' => 'userForm')) !!}

                            @include('comunicacion-interna/form', ['button' => trans('ui.comi.button_add')])
