            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        <div class="panel-heading">{{ trans('ui.area.new_area') }}</div>
                        <div class="panel-body">
                            @include('errors.form_error')

                            {!! Form::open(array('url' => 'area', 'class' => 'cmxform form-horizontal', 'id' => 'areaForm')) !!}

                            @include('area/form', ['button' => trans('ui.area.button_add')])
