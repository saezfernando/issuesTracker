            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        <div class="panel-heading">{{ trans('ui.ia.new_ia') }}</div>
                        <div class="panel-body">
                            @include('errors.form_error')
                            <!--enctype="multipart/form-data"-->
                            {!! Form::open(array('url' => 'informe-auditoria','files' => true, 'class' => 'cmxform form-horizontal', 'id' => 'informeAuditoriaForm')) !!}

                            @include('informe-auditoria/form', ['button' => trans('ui.ia.button_add')])
