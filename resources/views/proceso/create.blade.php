            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        <div class="panel-heading">{{ trans('ui.proceso.new_proceso') }}</div>
                        <div class="panel-body">
                            @include('errors.form_error')
                            <!--enctype="multipart/form-data"-->
                            {!! Form::open(array('url' => 'proceso','files' => true, 'class' => 'cmxform form-horizontal', 'id' => 'userForm')) !!}

                            @include('proceso/form', ['button' => trans('ui.proceso.button_add')])
