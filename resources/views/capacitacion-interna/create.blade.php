...
//Habilita el campo evaluacion capacitacion (CI) en el estado cerrado
    $('#estado').change(function(){
        
        if($('#estado').val() == 3) {
            $('#evaluacionCapacitacion').removeAttr('disabled');;
        }
        else
        {
            $('#evaluacionCapacitacion').attr('disabled','disabled');
        }
    });
})
