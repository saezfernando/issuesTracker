                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            {!! Form::model($permission, ['method' => 'PUT', 'route' => ['auth.permission.update', $permission->id], 'class' => 'cmxform form-horizontal', 'id' => 'permissionForm']) !!}

                            @include('auth/permission/form', ['button' => trans('ui.permission.button_update')])
