                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            {!! Form::model($user, ['method' => 'PUT', 'route' => ['auth.user.update', $user->id], 'class' => 'cmxform form-horizontal', 'id' => 'userForm']) !!}
                            

                            <!-- pasa usuario, rol, role_user, y boton (actualizar o crear)-->
                            @include('auth/user.form', array('user' => $user) + compact('roles', 'roles_user','areas','create'), ['button' => trans('ui.user.button_update'),'cancelar' => trans('ui.user.button_cancelar')])
