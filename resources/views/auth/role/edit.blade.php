            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        <div class="panel-heading">{{ trans('ui.role.edit_role') }}</div>
                        <div class="panel-body">
                            @include('errors.form_error')

                            {!! Form::model($role, ['method' => 'PUT', 'route' => ['auth.role.update', $role->id], 'class' => 'cmxform form-horizontal', 'id' => 'roleForm']) !!}

                            @include('auth/role/form', array('role' => $role) + compact('permissions', 'role_permission'), ['button' => trans('ui.role.button_update')])
